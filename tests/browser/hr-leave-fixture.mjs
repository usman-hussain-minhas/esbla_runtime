      ...
      await client.query(
        `INSERT INTO membership_capabilities (tenant_id, principal_id, capability_id)
         VALUES ($1, $2, 'hr.workforce.view_own'),
                ($1, $2, 'hr.workforce.view_authorized_detail'),
                ($1, $2, 'hr.leave.list_own'),
                ($1, $2, 'hr.leave.view'),
                ($1, $2, 'platform.notifications.list_own'),
                ($1, $2, 'platform.notifications.mark_read_own'),
                ($1, $2, 'platform.notifications.mark_all_read_own'),
                ...
                ($1, $4, 'hr.leave.view'),
                ($1, $4, 'platform.notifications.list_own'),
                ($1, $4, 'platform.notifications.mark_read_own'),
                ($1, $4, 'platform.notifications.mark_all_read_own'),
