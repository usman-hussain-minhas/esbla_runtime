...
export const PRESENTATION_SEMANTIC_SURFACE_DEFINITIONS = deepFreeze([
  ...
  },
  {
    ...
    contextualOrder: 2,
    deniedBehavior: "fail_closed",
    description: "The HR workforce-profile and employment-record operating surface.",
    eligibilityPolicy: "any_eligible_registered_widget_v1",
    exposure: "surface",
    ...
    taskOutcome: "Operate workforce profiles and employment records through eligible widgets.",
    unavailableBehavior: "truthful_unavailable",
    zeroEligibleBehavior: "hide_surface",
  },
  {
    ...
    contextualOrder: 3,
    deniedBehavior: "fail_closed",
    description: "The HR shift, attendance and timesheet operating surface.",
    eligibilityPolicy: "any_eligible_registered_widget_v1",
    exposure: "surface",
    fallbackSurfaceId: "surface.hr.mission-control",
    ...
    taskOutcome: "Operate shifts, attendance and timesheets through eligible widgets.",
    unavailableBehavior: "truthful_unavailable",
    zeroEligibleBehavior: "hide_surface",
  },
  {
    ...
    contextualOrder: 4,
    deniedBehavior: "fail_closed",
    description: "The HR leave-request and expense-claim operating surface.",
    eligibilityPolicy: "any_eligible_registered_widget_v1",
    exposure: "surface",
    fallbackSurfaceId: "surface.hr.mission-control",
    ...
    taskOutcome: "Operate leave requests and expense claims through eligible widgets.",
    unavailableBehavior: "truthful_unavailable",
    zeroEligibleBehavior: "hide_surface",
  },
