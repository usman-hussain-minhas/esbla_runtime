...
const REQUIRED_CORE_CAPABILITIES =
  "internal:platform.activation.set,internal:platform.evidence.append,internal:platform.notifications.list_own,internal:platform.notifications.mark_all_read_own,internal:platform.notifications.mark_read_own,internal:platform.notifications.project_internal,internal:platform.policy.evaluate,internal:platform.presentation.layouts.read_own,internal:platform.presentation.layouts.reset_own,internal:platform.presentation.layouts.write_own,internal:platform.presentation.preferences.read_own,internal:platform.presentation.preferences.write_own,internal:platform.presentation.shortcuts.read_own,internal:platform.presentation.shortcuts.write_own,internal:platform.presentation.tenant_defaults.write,internal:platform.settings.resolve,internal:platform.studio.surface_base.draft,internal:platform.studio.surface_base.publish,internal:platform.studio.surface_base.read,internal:platform.studio.surface_base.rollback,internal:platform.studio.surface_base.validate,internal:platform.tenant_transaction.run,internal:platform.work_item.manage".split(
    ",",
  );
