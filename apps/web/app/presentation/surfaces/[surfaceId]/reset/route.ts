...
import { resetOwnPresentationSurfaceOverlay } from "../../../../../lib/presentation-surfaces";
import {
...
export async function POST(
  ...
  let input: ReturnType<typeof parsePresentationSurfaceOverlayReset>;
  try {
    surfaceId = parseZenV1SurfaceId((await context.params).surfaceId);
    input = parsePresentationSurfaceOverlayReset(await request.json());
  } catch {
