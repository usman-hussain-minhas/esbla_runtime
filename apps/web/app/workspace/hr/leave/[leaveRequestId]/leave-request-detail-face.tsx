...
import { CalendarDays, Clock3, FileCheck2 } from "lucide-react";
import type { ReactNode } from "react";

interface HrLeaveRequestDetailFaceProps {
  readonly detail: HrLeaveRequestDetail;
...
export function HrLeaveRequestDetailFace({
  detail,
  leadingControl,
  mode,
}: HrLeaveRequestDetailFaceProps) {
